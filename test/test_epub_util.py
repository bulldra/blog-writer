...
from app.epub_util import extract_text_from_epub, chunk_text, get_epub_files, extract_metadata
...
def test_extract_text_from_epub_mock(mock_read_epub):
    ...
    mock_item.get_content.return_value = b"<html><body><h1>Chapter 1</h1><p>Test content</p></body></html>"
