...
@patch('app.routers.epub.get_epub_files')
@patch('app.routers.epub.extract_text_from_epub')
def test_get_book_chapters_book_not_found(mock_extract, mock_get_files, mock_get_settings):
    """書籍が見つからない場合のテスト"""
    from fastapi import HTTPException
...
@patch('app.routers.epub.get_epub_files')
@patch('app.routers.epub.extract_text_from_epub')
def test_get_book_chapters_extraction_error(mock_extract, mock_get_files, mock_get_settings):
    """テキスト抽出エラーのテスト"""
    from fastapi import HTTPException
...
@patch('app.routers.epub.get_epub_files')
@patch('app.routers.epub.extract_text_from_epub')
def test_get_book_chapters_multiple_files(mock_extract, mock_get_files, mock_get_settings):
