...
export default function SettingsPage() {
  ...
  return (
    <main style={{ maxWidth: 720, margin: "2rem auto", padding: "0 1rem" }}>
      <h1>AI 設定</h1>
      <p>
        プロバイダを選択してください。Gemini の場合は API キー、LM Studio
        の場合は Base URL（例: http://localhost:1234/v1）を保存します。
      </p>
      ...
      <input
        ...
        placeholder={
          provider === "gemini" ? "AIza..." : "http://localhost:1234/v1"
        }
        style={{ width: "100%" }}
      />
      ...
      <input
        ...
        onChange={(e) =>
          setMaxLen(
            Math.max(100, Math.min(131072, Number(e.target.value) || 32768)),
          )
        }
        style={{ width: "100%" }}
      />
